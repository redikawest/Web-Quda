...
<body>
    ...
    @foreach($data_news as $news)
        <div class="hero-blog-post bg-img bg-overlay" style="background-image:url(../images/{{$news->gb_berita}});">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a href="/PL-Kuda/mnews/{{$news->id}}/viewn" class="post-title" data-animation="fadeInUp" data-delay="300ms">{{$news->jd_berita}}</a>
                        </div>
                    </div>
                </div>
            </div>
