                ...
                <div class="col-12 col-xl-8">
                    <div class="archive-posts-area bg-white p-30 mb-30 box-shadow">
                        ...
                        <div class="single-catagory-post d-flex flex-wrap">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail bg-img" style="background-image: url(../images/{{$news->gb_berita}}); background-size:200px 150px ;">
                            ...
                            <div class="post-content">
                                <div class="post-meta">
                                    <a href="#">{{$news->tg_berita}}</a>
                                    <a href="#">News</a>
                                </div>
                                <a href="#" class="post-title">{{$news->jd_berita}}</a>
                                <!-- Post Meta -->

                                <p> <a href="/PL-Kuda/mnews/{{$news->id}}/viewn" class="btn btn-warning btn-sm">View More</a></p>
                            </div>
                        </div>
