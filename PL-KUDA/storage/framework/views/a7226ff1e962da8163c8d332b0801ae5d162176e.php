...
<body>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Event</a>
                                        <ul class="dropdown">
                                            <li><a href="/PL-Kuda/race">Pelatih</a></li>
    ...
    <div class="hero-area owl-carousel">
        <div class="container" style="padding-top: 100px;">
            ...
            <p>Daftar pelatih Kuda dapat berubah sewaktu-waktu (Kami akan selalu update).</p>
            <table class="table table-hover">
                ...
                <tbody>
                    <?php $__currentLoopData = $data_pelatih; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelatih): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($pelatih->nama_pelatih); ?></td>
                        <td><?php echo e($pelatih->j_kel); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\PL-KUDA\resources\views/pelatih.blade.php ENDPATH**/ ?>