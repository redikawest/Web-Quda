...
<body>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Event</a>
                                        <ul class="dropdown">
                                            <li><a href="/PL-Kuda/race">Joki</a></li>
    ...
    <div class="hero-area owl-carousel">
        <div class="container" style="padding-top: 100px;">
            <h4>Daftar joki</h4>
            <p>Daftar joki Kuda dapat berubah sewaktu-waktu (Kami akan selalu update).</p>
            <table class="table table-hover">
                ...
                <tbody>
                    <?php $__currentLoopData = $data_joki; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $joki): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($joki->nama_joki); ?></td>
                        <td><?php echo e($joki->j_kel); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\PL-KUDA\resources\views/joki.blade.php ENDPATH**/ ?>