...
<body>
    ...
    <?php $__currentLoopData = $data_news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="hero-blog-post bg-img bg-overlay" style="background-image:url(../images/<?php echo e($news->gb_berita); ?>);">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a href="/PL-Kuda/mnews/<?php echo e($news->id); ?>/viewn" class="post-title" data-animation="fadeInUp" data-delay="300ms"><?php echo e($news->jd_berita); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\PL-KUDA\resources\views/beranda.blade.php ENDPATH**/ ?>